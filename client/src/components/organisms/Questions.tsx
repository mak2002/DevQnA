...
import sortQuestionsByTimePeriod from "../../utils/sort";
...
function renderQuestions(
  ...
  return questions
    .sort(sortQuestionsByTimePeriod(sortOrder))
    .map((question: any) => {
      if (question) {
        return (
...
export default function AllQuestions({ questions, isLoading, sortOrder }: any) {
  return <div>{renderQuestions(questions, isLoading, sortOrder)}</div>;
}
